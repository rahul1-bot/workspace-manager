...
| Progress Todo | Keyboard Shortcuts Expansion (Non-Agents) | Date: 05 February 2026 | Time: 05:01 AM | Name: Ghost |

    1. Snapshot reference:
        1. logs/2026-02-05/workspace-manager_05_01_AM
    2. Objective:
        1. Expand keyboard-first control without introducing the Agents/Tasks schema yet.
        2. Add only shortcuts that map cleanly to existing Workspace and Terminal models.
        3. Defer Worker/Reviewer pairing and task-label keymaps until config and models support them.
    3. Features implemented:
        1. Focus Mode:
            1. Added appearance.focus_mode to config and persisted it in config.toml.
            2. Cmd+. toggles focus mode and hides the sidebar and terminal header.
            3. Focus mode adds a minimal overlay showing the active terminal and workspace.
        2. Command palette:
        ...
        3. Shortcut help overlay:
            ...
            2. Escape closes the help overlay.
            3. While help is open, key events are swallowed to avoid accidental terminal input.
        4. Workspace navigation alternatives:
            1. Shift+Cmd+I selects the previous workspace.
            2. Shift+Cmd+K selects the next workspace.
            3. Cmd+[ and Cmd+] remain bound to workspace switching for now to avoid churn until pairing ships.
        5. Workspace creation shortcut reliability:
            1. Shift+Cmd+N opens the New Workspace sheet and forces the sidebar visible.
            2. This duplicates the menu shortcut path to ensure reliability even when terminal surfaces are first responder.
        6. Terminal closing:
            1. Cmd+W prompts a confirmation before closing the selected terminal.
            2. Closing a terminal selects a neighboring terminal when possible to keep the UI stable.
        7. Config access:
            1. Cmd+, reveals config.toml in Finder for fast config-first edits.
        8. Terminal index jump:
            1. Option+Cmd+1..9 selects terminal index within the active workspace.
            2. Implemented by NSEvent keyCode mapping to ensure digits resolve correctly under Option-modified keyboard layouts.
    4. Files modified:
        1. Sources/WorkspaceManager/ContentView.swift
        2. Sources/WorkspaceManager/Views/Overlays.swift
        3. Sources/WorkspaceManager/Views/TerminalView.swift
        4. Sources/WorkspaceManager/Models/AppState.swift
        5. Sources/WorkspaceManager/Models/Config.swift
        6. Sources/WorkspaceManager/Services/ConfigService.swift
    5. Verification:
        1. ✅ swift build
        2. ✅ swift build -c release
