...
| Progress Todo | Performance Optimization | Date: 13 January 2026 | Time: 08:25 PM | Name: Ghost |

### Completed Tasks
    1. ✅ Disabled mouse reporting and update notifications in the terminal view.
    2. ✅ Enabled on-demand redraw policy and asynchronous layer drawing.
    3. ✅ Reasserted full redraw suppression on macOS.

### Next Steps
    1. Run the release bundle and compare CPU before/after these flags.
    2. If CPU remains high, profile with Instruments to confirm draw hot paths.

---

| Progress Todo | Git Baseline | Date: 13 January 2026 | Time: 08:06 PM | Name: Ghost |

### Completed Tasks
    1. ✅ Initialized a Git repository and set the branch to main.
    2. ✅ Committed the current working state with message “this works”.

### Next Steps
    1. Tag this commit if you want a named baseline for the performance phase.
